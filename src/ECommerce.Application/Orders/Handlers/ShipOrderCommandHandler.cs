...
public sealed class ShipOrderCommandHandler : IRequestHandler<ShipOrderCommand, OrderResponse>
{
    ...
    public ShipOrderCommandHandler(IBuyerRepository buyerRepository, IOrderRepository orderRepository)
    {
        _buyerRepository = buyerRepository;
        _orderRepository = orderRepository;
    }

    public async Task<OrderResponse> Handle(ShipOrderCommand command, CancellationToken cancellationToken)
    {
